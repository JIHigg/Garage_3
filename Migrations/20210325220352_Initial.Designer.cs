...
namespace Garage_3.Migrations
{
    ...
    [Migration("20210325220352_Initial")]
            ...
            modelBuilder.Entity("Garage_3.Models.Entites.Membership", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Base_Rate = 1.2m,
                            Birthdate = new DateTime(1991, 3, 25, 23, 3, 50, 889, DateTimeKind.Local).AddTicks(5283),
                            City = "Stockholm",
                            FirstName = "Kalle",
                            GarageId = 1,
                            Hourly_Rate = 2.3m,
                            ...
                            PostNumber = "11111",
                            RegistrationDate = new DateTime(2021, 3, 25, 23, 3, 50, 883, DateTimeKind.Local).AddTicks(7697)
                        },
                        new
                        {
                            MembershipId = 2,
                            Address = "123 Johan St",
                            Base_Rate = 1.2m,
                            Birthdate = new DateTime(1971, 3, 25, 23, 3, 50, 891, DateTimeKind.Local).AddTicks(389),
                            City = "Bag End",
                            FirstName = "Frodo",
                            GarageId = 1,
                            Hourly_Rate = 2.3m,
                            ...
                            Personnummer = "198706051234",
                            PostNumber = "22222",
                            RegistrationDate = new DateTime(2021, 3, 25, 23, 3, 50, 891, DateTimeKind.Local).AddTicks(311)
                        },
                        new
                        {
                            MembershipId = 3,
                            Address = "123 Johan St",
                            Base_Rate = 1.2m,
                            Birthdate = new DateTime(1956, 3, 25, 23, 3, 50, 891, DateTimeKind.Local).AddTicks(437),
                            City = "Hobbiton",
                            FirstName = "Samwise",
                            GarageId = 1,
                            Hourly_Rate = 2.3m,
                            ...
                            Personnummer = "198706051234",
                            PostNumber = "33333",
                            RegistrationDate = new DateTime(2021, 3, 25, 23, 3, 50, 891, DateTimeKind.Local).AddTicks(432)
                        },
                        new
                        {
                            MembershipId = 4,
                            Address = "123 Johan St",
                            Base_Rate = 1.2m,
                            Birthdate = new DateTime(1951, 3, 25, 23, 3, 50, 891, DateTimeKind.Local).AddTicks(451),
                            City = "Stockholm",
                            FirstName = "Meriadoc",
                            GarageId = 1,
                            Hourly_Rate = 2.3m,
                            ...
                            Personnummer = "198706051234",
                            PostNumber = "44444",
                            RegistrationDate = new DateTime(2017, 3, 25, 23, 3, 50, 891, DateTimeKind.Local).AddTicks(446)
                        });
                });
